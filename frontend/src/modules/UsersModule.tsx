...
const BC_MODULE_KEYS = ["dashboard", "revenue", "luy-ke", "backlog", "missing-parts", "tranh-chap", "nap-gas", "survey", "bao-cao-vi-pham", "bao-cao-nskx", "ca-lap", "danh-sach-tong", "import", "settings", "users", "giao-dien"];
...
const CUSTOMIZABLE_MODULE_KEYS = ["dashboard", "revenue", "luy-ke", "backlog", "missing-parts", "tranh-chap", "nap-gas", "survey", "bao-cao-vi-pham", "bao-cao-nskx", "ca-lap", "danh-sach-tong"];
