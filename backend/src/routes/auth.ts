...
auth.get("/callback", async (c) => {
  ...
  // Upsert ten hien thi (khong dong lai vai_tro/trang_thai_duyet o day - loadUser xu ly). Moi tai
  // khoan (ke ca KTV/Ve tinh) deu vao "Cho duyet" cho den khi Admin duyet thu cong.
