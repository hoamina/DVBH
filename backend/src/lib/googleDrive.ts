...
/**
 * Upload anh qua OAuth uy quyen 1 tai khoan Google THAT (xem routes/settings.ts phan "Google
 * Drive OAuth") - KHONG dung Service Account nhu uploadToDrive() o tren. Ly do: Service Account
 * khong co storage quota rieng, Google tra ve 403 "Service Accounts do not have storage quota"
 * cho moi file no tao ra tru khi dich la 1 Shared Drive (yeu cau Google Workspace tra phi) - da
 * xac nhan truc tiep qua API 2026-08-17. Khi uy quyen 1 tai khoan that, file thuoc quota cua
 * chinh nguoi do nen khong bi chan.
 *
 ...
 * list/modal, khong can nguoi xem dang nhap Google (CHOT 2026-08-17: anh khong nhay cam, uu tien
 * don gian/nhanh hon la proxy qua Worker).
 */
